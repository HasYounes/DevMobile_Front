          ...
          floatingActionButton: ButtonWidget(
            ...
            onPressed: () {
              () async {
                ...
                //     0,
                //     "Hey",
                //     responseBody["client_id"] == myId
                //         ? responseBody["designer_id"]
                //         : responseBody["client_id"],
                //     responseBody["id"],
                //     myId,
                //     DateTime.now()));
                // ref.read(socketServiceProvider).send({
                //   "messages": [
                //     {"content": "hey", "disc_id": responseBody["id"]}
                //   ]
                // });
                Navigator.push(
                    context,
...
//               () async {
//                 var response = await post(
//                     Uri.parse("Config.urlAuthority/discussions/create"),
//                     headers: {
//                       "Authorization": Config.jwt
//                     });
